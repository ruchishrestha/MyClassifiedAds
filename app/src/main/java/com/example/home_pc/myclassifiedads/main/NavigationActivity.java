...
import com.example.home_pc.myclassifiedads.contacts.ContactsFragment;
...
import com.example.home_pc.myclassifiedads.draweritemsfragments.MyAccountFragment;
...
import com.example.home_pc.myclassifiedads.wanteds.WantedFragment;
...
public class NavigationActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState==null) {
            selectNavDrawerItem(2, 2, upperDrawerListItems);
        }
    }
