...
public class WantedAddActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.add_wanteds);

        uploadedPic=(ImageView) findViewById(R.id.wantedImage);
        uploadPic=(TextView) findViewById(R.id.uploadPics);
        title=(EditText) findViewById(R.id.title);
        description=(EditText) findViewById(R.id.description);
        category = (Spinner) findViewById(R.id.wantedCategory);
        aDdress=(EditText) findViewById(R.id.aDdress);
        contactNo=(EditText) findViewById(R.id.wantedContact);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_wanted_add, menu);
        return true;
    }
