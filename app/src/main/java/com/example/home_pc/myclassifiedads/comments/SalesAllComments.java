...
import com.example.home_pc.myclassifiedads.comments.SalesCommentAdsAdapter;
...
public class SalesAllComments extends ActionBarActivity {
    ...
    protected class AsyncLoadAllComments extends
        ...
        protected void onPostExecute(ArrayList<CommentObject> result) {
            if(result==null){
                ...
                SalesCommentAdsAdapter cad=new SalesCommentAdsAdapter(result,adid);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_sales_all_comments, menu);
        return true;
    }
